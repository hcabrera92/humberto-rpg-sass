...
function carouselAnimationQuests() {
    const grid = document.querySelector(".chapter4__content .grid");
    const cards = document.querySelectorAll(".chapter4__content .chapter3__card");
...
window.carouselAnimationQuests = carouselAnimationQuests;